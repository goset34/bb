...
export const P = {
  ...
  sculkPhase: new EnumProperty('sculk_sensor_phase', ['inactive', 'active', 'cooldown'] as const),
  ...
  creakingState: new EnumProperty('creaking_heart_state', ['uprooted', 'dormant', 'awake'] as const),
